      ...
      <nav  class="navbar navbar-expand navbar-light bg-white static-top osahan-nav sticky-top">
         ...
         <ul  class="navbar-nav ml-auto ml-md-0 osahan-right-navbar">
            ...
            <li class="nav-item dropdown no-arrow osahan-right-navbar-user">
               ...
               <img alt="Avatar" src='img/pasfoto.png' >
               Arief
               </a>
...
<!-- Awal 1 Row-->
      ...
      <div class="row py-3">
        <div  class="col-md-6">
            <h1>Yakin udah siap masuk PTN 2023?</h1>
            <p>Walau hanya TPS yang diuji, nggak berarti 
                gampang lolos seleksi. Persaingan makin ketat, 
                kompetisi makin berat. Siap-siap hajar PTN 2023 
                bareng Gempi biar makin PD tembus ke Universitas 
                impian kamu!</p>
        ...
        <div class="col-md-6">
          ...
          <img style="width: 250px; margin-left: 100px;"src="img/favicon.png" alt="">
...
<div class="container py-5">
      ...
      <div class="col-md-6">
          ...
          <img style="width: 350px; margin-left: 30px;margin-top:100px;"src="img/jerome.jpeg" alt="">
           
          </div>
        </div>
        <div class="col-md-6">
            <h2>Makin Jago Bernalar dan Lolos SNBT (UTBK) Bareng Gempi!</h2>
            <ul>
                <li>
                    <h5>93.7% siswa tidak lulus standar kompetensi*</h5>
                    <p>walaupun yang diuji hanya kemampuan skolastik, banyak yang masih kesulitan dengan
                         tipe soal terbaru, nih! *dari total peserta 17,043</p>
                </li>
                <li>
                    <h5>93.7% siswa tidak lulus standar kompetensi*</h5>
                    <p>walaupun yang diuji hanya kemampuan skolastik, banyak yang masih kesulitan dengan
